...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <table id="cartTable">
            ...
            <tbody>
                <asp:Repeater ID="Repeater1" ItemType="GameStore.Models.CartLine" SelectMethod="GetCartLines" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <tr>
                            <td><%# Item.Quantity %></td>
                            ...
                            <td>
                                <button type="submit" class="actionButtons" name="remove" value="<%#Item.Game.GameId %>">
                                    Удалить
                                </button>
                            </td>
                        </tr>
